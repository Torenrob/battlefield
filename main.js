...
`, "",{"version":3,"sources":["webpack://./src/styles/style.css"],"names":[],"mappings":"AAAA;CACC,gCAAgC;CAChC,aAAa;CACb,aAAa;CACb,0CAA0C;CAC1C,+BAA+B;AAChC;AACA;CACC,aAAa;CACb,uCAAuC;CACvC,WAAW;AACZ;AACA;CACC,WAAW;CACX,YAAY;CACZ,sBAAsB;CACtB,kBAAkB;CAClB,iBAAiB;CACjB,eAAe;AAChB;;AAEA;CACC,sBAAsB;AACvB;;AAEA;CACC,aAAa;CACb,6BAA6B;CAC7B,kBAAkB;AACnB;;AAEA;CACC,uBAAuB;AACxB;;AAEA;CACC,uBAAuB;AACxB;;AAEA;CACC,kBAAkB;CAClB,kBAAkB;CAClB,aAAa;CACb,sBAAsB;CACtB,cAAc;CACd,uBAAuB;CACvB,WAAW;CACX,YAAY;CACZ,QAAQ;CACR,SAAS;CACT,gCAAgC;CAChC,oCAAoC;CACpC,mBAAmB;AACpB;;AAEA;CACC,kBAAkB;CAClB,kBAAkB;AACnB;;AAEA;CACC,kBAAkB;CAClB,kBAAkB;AACnB;;AAEA;CACC,kBAAkB;CAClB,kBAAkB;AACnB","sourcesContent":["body {\n\tfont-family: \"Arial\", sans-serif;\n\tdisplay: grid;\n\theight: 100vh;\n\tgrid-template-columns: 0.5fr 1fr 1fr 0.5fr;\n\tgrid-template-rows: 1fr 1fr 1fr;\n}\n.grid {\n\tdisplay: grid;\n\tgrid-template-columns: repeat(10, 40px);\n\tmargin: 0px;\n}\n.cell {\n\twidth: 40px;\n\theight: 40px;\n\tborder: 1px solid #ccc;\n\ttext-align: center;\n\tline-height: 40px;\n\tcursor: pointer;\n}\n\n.cell:hover {\n\tbackground-color: aqua;\n}\n\n#gridWrap {\n\tdisplay: flex;\n\tjustify-content: space-around;\n\tgrid-area: 2/2/2/4;\n}\n\n#playerGrid {\n\tborder: black 1px solid;\n}\n\n#computerGrid {\n\tborder: black 1px solid;\n}\n\n#nameDialog {\n\tvisibility: hidden;\n\tposition: absolute;\n\tdisplay: flex;\n\tflex-direction: column;\n\tpadding: 0.75%;\n\tjustify-content: center;\n\twidth: 22vw;\n\theight: 12vh;\n\ttop: 37%;\n\tleft: 50%;\n\ttransform: translate(-50%, -50%);\n\tbackground-color: rgb(102, 102, 102);\n\tborder-radius: 15px;\n}\n\n#playerName {\n\tgrid-area: 3/2/3/2;\n\ttext-align: center;\n}\n\n#compName {\n\tgrid-area: 3/3/3/3;\n\ttext-align: center;\n}\n\n#title {\n\tgrid-area: 1/2/1/4;\n\ttext-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony export */   nameDialog: () => (/* binding */ nameDialog),
/* harmony export */   placeShips: () => (/* binding */ placeShips),
/* harmony export */   playerGridElement: () => (/* binding */ playerGridElement),
/* harmony export */   playerNameDisplay: () => (/* binding */ playerNameDisplay)
/* harmony export */ });
...
class Ship {
	...
	hit() {
		this.timesHit += 1;
		/* eslint-disable */console.log(...oo_oo(`2420855922_10_2_10_27_4`,`Its a hit!`));
		this.isSunk();
	}
	...
	isSunk() {
		if (this.timesHit === this.length) {
			this.sunk = true;
			/* eslint-disable */console.log(...oo_oo(`2420855922_17_3_17_58_4`,`You sunk their ${this.length} spot ship!`));
		}
	}
}
...
class gameBoard {
	...
	receiveAttack(xAxis, yAxis) {
		...
		if (hitTrack === 0) {
			/* eslint-disable */console.log(...oo_oo(`2420855922_92_3_92_30_4`,`It's a miss.`));
...
_DOM_js__WEBPACK_IMPORTED_MODULE_3__.createGrid(_DOM_js__WEBPACK_IMPORTED_MODULE_3__.playerGridElement, "player");
_DOM_js__WEBPACK_IMPORTED_MODULE_3__.createGrid(_DOM_js__WEBPACK_IMPORTED_MODULE_3__.computerGridElement);
_DOM_js__WEBPACK_IMPORTED_MODULE_3__.getName();
_DOM_js__WEBPACK_IMPORTED_MODULE_3__.placeShips();
